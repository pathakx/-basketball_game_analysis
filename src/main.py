...
from analytics.team_assigner.team_assigner import TeamAssigner
from detectors.court_keypoint_detector.court_keypoint_detector import CourtKeypointDetector
from acquisition.ball_acquisition.ball_aquisition_detector import BallAquisitionDetector
from detectors.pass_and_interception_detector.pass_and_interception_detector import PassAndInterceptionDetector
from visualization.tactical_view_converter.tactical_view_converter import TacticalViewConverter
from analytics.speed_and_distance_calculator.speed_and_distance_calculator import SpeedAndDistanceCalculator
from visualization.drawers import (
    PlayerTracksDrawer, 
    BallTracksDrawer,
    CourtKeypointDrawer,
...
def main():
    ...
    tactical_view_converter = TacticalViewConverter(
        court_image_path="assets/images/basketball_court.png"
    )
